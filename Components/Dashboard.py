        ...
        dbc.Row([
            dbc.Col(                    
                ...
                [
                    ...
                    dbc.CardBody(
                        [
                           dcc.Loading(html.H4(id='card1', className="card-title, card text-info")),
                        ],
                    ),
                ],
            ...
            ,dbc.Col(
                ...
                [
                    ...
                    dbc.CardBody(
                        [
                            dcc.Loading(html.H4(id='card2', className="card-title,card text-success")),
                        ],
                    ),
                ],
            ...
            ,dbc.Col(
                    ...
                    [
                        ...
                        dbc.CardBody(
                            [
                                dcc.Loading(html.H4(id='card3', className="card-title, card text-danger")),
                            ]
                        ),
                    ],
                    style={"width": "18rem","margin-left":"50px"},
